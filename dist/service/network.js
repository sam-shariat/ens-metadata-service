...
function getNetwork(network) {
    ...
    switch (network) {
        ...
        case exports.NETWORK.SEPOLIA:
            ...
            break;
        case exports.NETWORK.ARBITRUM_SEPOLIA:
    ...
    if (network === exports.NETWORK.ARBITRUM_SEPOLIA) {
        var ens = new ethers_1.EnsPlugin('0x559Ab8a76956436B16918CfDfB291d768264CdEc', 421614);
        var _network = new ethers_1.Network(network, 421614).attachPlugin(ens);
