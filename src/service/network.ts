...
export default function getNetwork(network: NetworkName): {
  ...
  if (network === NETWORK.ARBITRUM_SEPOLIA) {
    const ens = new EnsPlugin('0x559Ab8a76956436B16918CfDfB291d768264CdEc',421614);
    const _network = new Network(network, 421614).attachPlugin(ens);
